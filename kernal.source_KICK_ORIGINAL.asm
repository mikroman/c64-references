//	.nam C64 KERNAL  (C)1982 CBM
//	.subttl Copyright (C) 1982 Commodore Business Machines, Inc.

// Converted to VAX/VMS BSO format by Fred Bowen

// ###########################################################################
// #########    Converted to Kick Assembler format by Mike Loewen    #########
// ###########################################################################

// 
// ###########################################################################
// ###########################################################################
// ##  This Kick version contains the entire original source code comments. ##
// ################### My comments include a "KICK_" prefix ##################
// ###########################################################################
// ###########################################################################
...
.const  eot       =     5		//end of tape
.const  blf       =     1		//basic load file
.const  bdf       =     2		//basic data file
.const  plf       =     3		//fixed program type
.const  bdfh      =     4		//basic data file header
.const  bufsz     =     192		//buffer size

//
// screen editor constants
//

.const llen       =     40		//single line 40 columns
.const llen2      =     80		//double line = 80 columns
.const nlines     =     25		//25 rows on screen
.const white      =     $01		//white screen color
.const blue       =     $06		//blue char color
...
.const sberr      =     4
.const lberr      =     8
.const sixty      =     17045  	        //ntsc
.const sixtyp     =     16421  	        //pal
.const cbit       =     100  	        //cycles
.const maxchr	  =     80
.const nwrap	  =     2	        //max   number  of  physical  lines  per  logical  line
.const timrb      =     $19		//6526 crb enable one-shot tb


* = $0000 "page zero-1" virtual

d6510: 	.byte $00		//6510 data direction register
r6510: 	.byte $00		//6510 data register
pch:   	.byte $00		//virtual regs for machine language monitor
pcl:   	.byte $00
flgs:  	.byte $00
acc:   	.byte $00
xr:    	.byte $00
yr:    	.byte $00
sp:    	.byte $00
invh:  	.byte $00		//user modifiable irq
invl:  	.byte $00

* = $0090 "page zero-2" virtual

status:	.byte $00		//i/o operation status byte
//crfac	.fill 2,0		//correction factor (unused)
stkey: 	.byte $00		//stop key flag
svxt:  	.byte $00		//temporary
verck:	.byte $00		//load or verify flag
c3p0:  	.byte $00		//ieee buffered char flag
bsour: 	.byte $00		//char buffer for ieee
syno:  	.byte $00		//cassette sync #
xsav:  	.byte $00		//temp for basin
ldtnd: 	.byte $00		//index to logical file
dfltn: 	.byte $00		//default input device #
dflto: 	.byte $00		//default output device #
prty:  	.byte $00		//cassette parity
dpsw:  	.byte $00		//cassette dipole switch
msgflg:	.byte $00		//os message flag
ptr1:
t1:	.byte $00		//temporary 1
tmpc:                           //cassette error pass2
ptr2:
t2:     .byte $00		//temporary 2
time:  	.fill 3,0		//24 hour clock in 1/60th seconds
r2d2:			        //serial bus usage
pcntr: 	.byte $00		//cassette stuff
//ptch: .byte $00		//(unused)
bsour1:			        //temp used by serial routine
firt:  	.byte $00
count:			        //temp used by serial routine
cntdn: 	.byte $00		//cassette sync countdown
bufpt: 	.byte $00		//cassette buffer pointer
inbit:			        //rs-232 rcvr input bit storage
shcnl: 	.byte $00		//cassette short count
bitci:			        //rs-232 rcvr bit count in
rer:   	.byte $00		//cassette read error
rinone:			        //rs-232 rcvr flag for start bit check
rez:   	.byte $00		//cassete reading zeroes
ridata:			        //rs-232 rcvr byte buffer
rdflg: 	.byte $00		//cassette read mode
riprty:			        //rs-232 rcvr parity storage
shcnh: 	.byte $00		//cassette short cnt
sal:   	.byte $00
sah:   	.byte $00
eal:   	.byte $00
eah:   	.byte $00
cmp0:  	.byte $00
temp:  	.byte $00
tape1: 	.fill 2,0		//address of tape buffer #1y.
...
prp:   	.byte $00
fnlen: 	.byte $00		//length current file n str
la:    	.byte $00		//current file logical addr
sa:    	.byte $00		//current file 2nd addr
fa:    	.byte $00		//current file primary addr
fnadr: 	.fill 2,0		//addr current file name str
roprty:			        //rs-232 trns parity buffer
ochar: 	.byte $00
fsblk: 	.byte $00		//cassette read block count
mych:  	.byte $00
cas1:  	.byte $00		//cassette manual/controlled switch
tmp0:
stal:  	.byte $00
stah:  	.byte $00
...
lstx:  	.byte $00		//key scan index
//sfst: .byte $00		//keyboard shift flag (unused)
ndx:   	.byte $00		//index to keyboard q
rvs:   	.byte $00		//rvs field on flag
indx:  	.byte $00
lsxp:  	.byte $00		//x pos at start
lstp:  	.byte $00
sfdx:  	.byte $00		//shift mode on print
blnsw: 	.byte $00		//cursor blink enab
blnct: 	.byte $00		//count to toggle cur
gdbln: 	.byte $00		//char before cursor
blnon: 	.byte $00		//on/off blink flag
crsw:  	.byte $00		//input vs get flag
pnt:   	.fill 2,0		//pointer to row
//point	.byte $00		//(unused)
pntr:  	.byte $00		//pointer to column
qtsw:  	.byte $00		//quote switch
lnmx:  	.byte $00		//40/80 max positon
tblx:  	.byte $00
data:  	.byte $00
insrt: 	.byte $00		//insert mode flag
ldtb1: 	.fill 26,0		//line flags+endspace
user:  	.fill 2,0		//screen editor color ip
keytab:	.fill 2,0		//keyscan table indirect

//
// rs-232 z-page
//

ribuf: 	.fill 2,0		//rs-232 input buffer pointer
robuf: 	.fill 2,0		//rs-232 output buffer pointer
frekzp:	.fill 4,0		//free kernal zero page 9/24/80
baszpt:	.byte $00		//location ($00ff) used by basic

	* = $0100 "page one" virtual

bad:   	.byte $00

	* = $0200 "page two" virtual

buf:   	.fill 89,0		//basic/monitor buffer

//
// tables for open files
//

lat:   	.fill 10,0		//logical file numbers
fat:   	.fill 10,0		//primary device numbers
sat:   	.fill 10,0		//secondary addresses

//
// system storage
//

keyd:  	.fill 10,0		//irq keyboard buffer
memstr:	.fill 2,0		//start of memory
memsiz:	.fill 2,0		//top of memory
timout:	.byte $00		//ieee timeout flag

//
// screen editor storage
//

color: 	.byte $00		//activ color nybble
gdcol: 	.byte $00		//original color before cursor
hibase:	.byte $00		//base location of screen (top)
xmax:  	.byte $00
rptflg:	.byte $00		//key repeat flag
kount: 	.byte $00
delay: 	.byte $00
shflag:	.byte $00		//shift flag byte
lstshf:	.byte $00		//last shift pattern
keylog:	.fill 2,0		//indirect for keyboard table setup
mode:  	.byte $00		//0-pet mode, 1-cattacanna
autodn:	.byte $00		//auto scroll down flag(=0 on,<>0 off)

//
// rs-232 storage
//

m51ctr:	.byte $00		//6551 control register
m51cdr:	.byte $00		//6551 command register
m51ajb:	.fill 2,0		//non standard (bittime/2-100)
rsstat:	.byte $00		//rs-232 status register
bitnum:	.byte $00		//number of bits to send (fast response)
baudof:	.fill 2,0		//baud rate full bit time (created by open)

//
// reciever storage
//

//inbit:  .byte $00		//input bit storage
//bitci:  .byte $00		//bit count in
//rinone: .byte $00		//flag for start bit check
//ridata: .byte $00		//byte in buffer
//riprty: .byte $00		//byte in parity storage
ridbe: 	.byte $00		//input buffer index to end
ridbs: 	.byte $00		//input buffer pointer to start

//
// transmitter storage
//

//bitts:  .byte $00		//# of bits to be sent
//nxtbit: .byte $00		//next bit to be sent
//roprty: .byte $00		//parity of byte sent
//rodata: .byte $00		//byte buffer out
rodbs: 	.byte $00		//output buffer index to start
rodbe: 	.byte $00		//output buffer index to end
irqtmp:	.fill 2,0		//holds irq during tape ops

//
// temp space for vic-40 variables ****
//

enabl: 	.byte $00		//rs-232 enables (replaces ier)
caston:	.byte $00		//tod sense during cassettes
kika26:	.byte $00		//temp storage for cassette read routine
stupid:	.byte $00		//temp d1irq indicator for cassette read
lintmp:	.byte $00		//temporary for line index
palnts:	.byte $00		//pal vs ntsc flag 0=ntsc 1=pal


	* = $0300 "page three-1" virtual	//rem program   indirects(10)
	* = $0300+$14 "page three-2" virtual	//rem kernal/os indirects(20)

cinv:  	.fill 2,0		//irq ram vector
cbinv: 	.fill 2,0		//brk instr ram vector
nminv: 	.fill 2,0		//nmi ram vector
iopen: 	.fill 2,0		//     indirects for code
iclose:	.fill 2,0		//     conforms to kernal spec 8/19/80
ichkin:	.fill 2,0
ickout:	.fill 2,0
iclrch:	.fill 2,0
ibasin:	.fill 2,0
...
usrcmd:	.fill 2,0
iload: 	.fill 2,0
isave: 	.fill 2,0		//savesp


	* = $0300+60 "page three-3" virtual

tbuffr:	.fill 192,0		//cassette data buffer

	* = $0400 "page four" virtual

vicscn:	.fill 1024,0
ramloc:                         // #### unsused label
...
viccol:	.fill 1024,0	//vic color nybbles

     	* = $dc00 "CIA1" virtual	//device1 6526 (page1 irq)
...
d1crb: 	.byte $00
     	...
     	* = $dd00 "CIA2" virtual	//device2 6526 (page2 nmi)
...
fpat00:
        ldy  stkey  	//check  for  key  down  on  last  row...
        iny
...
baudop:
	...
	//.page
//	.subttl EDITOR1
	* = $e500 "ROM_KENAL_ENTRY" //start of commodore 64 kernal
...
// rts
//
// unmsg .byte $d,'?advanced function not available',$d
// unmsg2
//
...
//
        ...
        sta  mode
        sta  blnon  	//we don't have a good char from the screen yet
        ...
        sta  delay
        lda  #14  	//init color to lt blue 901227-03*************
        sta  color
        lda  #4
...
vpan:
        jsr  panic  	//fix  vic  screen
        jmp  nxtd  	//home  cursor

//	.space   2

panic:
        lda  #3  	//reset  default  i/o
        sta  dflto
        lda  #0
        sta  dfltn
...
coltab:		//blk,wht,red,cyan,magenta,grn,blue,yellow
...
lower:
        ...
        lda  vicreg+24  	//else  set  vic  to  point  to  lower  c
ase:
        ora  #$02
        bne  ulset  	//jmp
...
upper:
        ...
        lda  vicreg+24  	//make  sure  vic  point  to  upper/pet
set:
        and  #$ff-$02
ulset:   sta  vicreg+24
outhre:  jmp  loop2
...
.const linz0    =  vicscn
.const linz1    =  linz0+llen
.const linz2    =  linz1+llen
.const linz3    =  linz2+llen
.const linz4    =  linz3+llen
.const linz5    =  linz4+llen
.const linz6    =  linz5+llen
.const linz7    =  linz6+llen
.const linz8    =  linz7+llen
.const linz9    =  linz8+llen
.const linz10   =  linz9+llen
.const linz11   =  linz10+llen
.const linz12   =  linz11+llen
.const linz13   =  linz12+llen
.const linz14   =  linz13+llen
.const linz15   =  linz14+llen
.const linz16   =  linz15+llen
.const linz17   =  linz16+llen
.const linz18   =  linz17+llen
.const linz19   =  linz18+llen
.const linz20   =  linz19+llen
.const linz21   =  linz20+llen
.const linz22   =  linz21+llen
.const linz23   =  linz22+llen
.const linz24   =  linz23+llen
        //.space  3
...
//
        ...
        asl  	//carry  tell  how  may  stop  bits
        lda  #01
        adc  bitci
        bne  rsrext  	//no..exit
//
...
ms6:      .text  "FOR"
.byte $a0,$0D
ms7:      .text  "PRESS PLAY ON TAP"
.byte $c5
ms8:      .text  "PRESS RECORD & PLAY ON TAP"
.byte $c5,$0D
ms10:     .text  "LOADIN"
.byte $c7,$0D
ms11:     .text  "SAVING"
...
read:    ldx  d1t2h  	//get  time  since  last  interrupt
        ...
        stx  temp
        lsr  	//move  two  bits  from  high  to  temp
        ror  temp
        lsr
        ror  temp
...
a0in2:   rts
//
tbla0r:   .byte  $c3,$c2,$cd,$38,$30  	//..cbm80..
tbla0e:
//	//.space   4
...
ramtas:  lda  #0  	//zero  low  memory
        tay  	//start  at  0002
ramtz0:  sta.a  $0002,y  	//zero  page
        sta.a  $0200,y  	//user  buffers  and  vars
        sta.a  $0300,y  	//system  space  and  user  space
        iny
        bne  ramtz0
//
...
//.end
	...
	* = $ff80 "JMP1"
	...
	.byte   3  	//release  number  of  c64  kernal

        jmp  pcint
        jmp  ioinit
        jmp  ramtas

	* = $ff8a "JMP2"	//new   vectors  for  basic
